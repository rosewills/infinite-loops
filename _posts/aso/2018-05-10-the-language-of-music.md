...
tags:
  - aso
cover: aso-articles/guitar.webp
preview: aso-articles/guitar.webp
cover-alt:
published: true
...
Yet despite our collective obsession with music, the phenomenon remains as mysterious as it is ubiquitous. Music is both precisely [mathematical](https://www.ams.org/publicoutreach/math-and-music) and utterly subjective. No two people hear it the same way, yet it is universally present in virtually every known culture. What's more, while the [oldest discovered instruments](http://www.bbc.com/news/science-environment-18196349) suggest music dates back to prehistoric times, it isn't, strictly speaking, necessary for survival. Steven Pinker, head of MIT's evolutionary psychology department, goes so far as to call it "[auditory cheesecake](https://www.researchgate.net/publication/236814528_Steven_Pinker's_Cheesecake_for_the_Mind);" he argues that our affinity for music (like our taste for cheesecake) is simply a side effect of more vital instincts. "Music could vanish from our species," he claims, "and the rest of our lifestyle would be virtually unchanged."
...
[![guitar.jpg]({{ site.baseurl }}/assets/images/aso-articles/guitar.webp)]({{ site.baseurl }}/assets/images/aso-articles/guitar.webp)
...
[![dancing-dolls.jpg]({{ site.baseurl }}/assets/images/aso-articles/dancing-dolls.webp)]({{ site.baseurl }}/assets/images/aso-articles/dancing-dolls.webp)
...
Clearly, music is not just a random cocktail of sounds that please us. It is unique and idiosyncratic to each musician in such a distinct way that even a program can pick out pieces of a particular composer's "voice." In an [interview with Radiolab](http://www.radiolab.org/story/91515-musical-dna/), Cope himself emphatically stated, "there is _nothing_ intelligent about my program in the slightest;" EMI simply detects and reprints the musical signatures it finds, scrawled in patterns original only to human beings. Thus, in these brand-new pieces, a composer's fingerprint can be re-traced as easily as a portrait can be redrawn.
...
[![orchestra.jpg]({{ site.baseurl }}/assets/images/aso-articles/orchestra.webp)]({{ site.baseurl }}/assets/images/aso-articles/orchestra.webp)
