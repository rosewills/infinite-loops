...
source-url: https://athensscienceobserver.com/2017/12/21/finding-your-way-home/
source-title: Finding Your Way Home
ready: true
---
...
[![snow-road.jpg]({% link /assets/images/aso-articles/snow-road.jpg %})](/assets/images/aso-articles/snow-road.jpg)
...
Scientists aren't sure exactly where sensory organs associated with magnetoreception might be located, making it difficult to study. So far, there are two proposed theories for how it works: the first relies on tiny magnetite particles in [specialized cells](http://www.pnas.org/content/109/30/12022.abstract) (first discovered in bacteria and trout) that align themselves with an applied magnetic field; the other involves [cryptochrome](http://www.ks.uiuc.edu/Research/cryptochrome/), a molecule found in the eyes of many birds that could [allow them to "see"](http://www.ks.uiuc.edu/Research/cryptochrome/) magnetic fields.
